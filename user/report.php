...
<?php
		...
		$data_work=mysqli_fetch_assoc($run_work);
		$wid=$data_work['w_id'];
			...
			<div class="container">		
				...
				<br><br>					
									...
									<div class="row">
										...
										<div class="col-lg-12 col-md-12 col-sm-12 shadow border_bottom" id="shadow" >
											<div class="justify-content-center" id="job_contaner">
												...
												<h1 align="right" class="text-success">Received<br><?php echo "$".$credit;?></h1>
					...
					<div class="text-center float-left">
						<a href="user_index.php" class="btn btn-success h5"><--Back</a>
					</div>																	
