...
/*---------------------------- NAVBAR -----------------------------------*/
	...
	/*------------ JOB LIST ------*/
		...
		$query_hire="SELECT * FROM `jobs` WHERE `h_id`='$username' AND `status`='working' ";
	...
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 shadow border_bottom" id="shadow" >
			<div class="justify-content-center" id="job_contaner">
				...
				?>
				<h5><strong class="text-warning float-right"><i class="fas fa-hourglass"></i> <?php echo $row1['status'],"...";?></strong></h5><br>								
				<h5><strong class="job_title float-right"><i class="fas fa-user"></i> <?php echo $data['w_fname']," ",$data['w_lname'];?></strong></h5>				
			...
			<?php
				...
				{ ?>
					<a href="view_submit_job.php?jid=<?php echo $id;?>" class="btn btn-success float-right">Approve Submited Project</a>					
					<?php
				}
			?>																			
				<br>					
