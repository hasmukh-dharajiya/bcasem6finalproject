			...
			<div class="container">		
				<div class="row">					
					...
					<div class="col-lg-10 col-md-10 col-sm-10"><br><br>
						...
						<p><?php echo $data['expertise'];?></p>
						<p><?php echo $data['time_duration'];?></p>
						<p><?php echo $data['budget'];?></p>
						<a href="../data_image\<?php echo $data['submit_file'];?>" class="btn btn-success" download>Dowonlod File</a>
					</div>										
				</div>												
				<br><br>					
				<div class="text-center">
					<a href="reject_submited_job.php?jid=<?php echo $data['j_id'];?>" class="btn btn-danger">Reject	Project</a>
					<a href="payment_job.php?jid=<?php echo $data['j_id'];?>" class="btn btn-success">Approve Project</a>
				</div>
					<div class="text-center">
						<a href="working_jobs.php" class=" text-success float-left"><--Back</a>
					</div><br><br><br>												
